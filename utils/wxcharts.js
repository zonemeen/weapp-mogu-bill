...
function k(t, e, i, n, a, o) {
    n.beginPath(), n.setLineWidth(1), n.setFillStyle(e), "diamond" === i ? t.forEach(function(t, e) {
        null !== t && (n.moveTo(t.x, t.y - 4.5), n.lineTo(t.x - 4.5, t.y), n.lineTo(t.x, t.y + 4.5), 
        n.lineTo(t.x + 4.5, t.y), n.lineTo(t.x, t.y - 4.5));
    }) : "circle" === i ? (n.setFillStyle(a), t.forEach(function(t, e) {
...
function N(t, e, i, n) {
    ...
    t.forEach(function(t, e) {
        ...
        d.transX, d.transY, n.fillText(t, r[o] + f, l + i.fontSize + 5), n.closePath(), 
        n.stroke(), n.restore();
    }), n.restore();
}
